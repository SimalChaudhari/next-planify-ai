...
export default function SuzukaMotionPath({
  duration = 5000,
  className = "",
}) {
  ...
  useEffect(() => {
    ...
    if (!container) return;
    const pathEl = container.querySelector("#suzuka");
    const carEl = container.querySelector(".car");
  ...
  return (
    <div
      ...
      className={className}
    >
      <svg viewBox="0 0 304 112" className="w-full h-auto">
        <title>Suzuka</title>
